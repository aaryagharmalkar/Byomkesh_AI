    ...
    <section data-testid="evidence-panel" className="section">
      ...
      <div className="grid-evidence">
        {entities.map((entity, index) => {
          const category = (entity.category || "").toUpperCase();
          ...
          return (
            <article
              ...
              className={`card-noir p-5 fade-up stagger-${Math.min(
                6,
                (index % 6) + 1
              )}`}
            >
              ...
              {/* Label */}
              {entity.label && (
                <div className="mt-3 font-stencil text-[11px] text-[#6b7280]">
                  {entity.label}
                </div>
              )}
              ...
              {/* Value */}
              <div
                data-testid={`evidence-card-value-${index}`}
              ...
              <div className="mt-4 flex items-center justify-between">
                <span className={getConfidenceClass(entity.confidence)}>
                  CONF · {entity.confidence || "N/A"}
                </span>
